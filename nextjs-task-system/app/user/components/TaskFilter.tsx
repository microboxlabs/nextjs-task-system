...
export default function TaskFilter({ filters, onFilterChange }: TaskFiltersProps) {
    const { handleSortChange } = useUserTask()
    ...
    return (
        <div className="w-full flex flex-wrap sm:flex-nowrap sm:flex-row items-center justify-between gap-2.5 max-w-6xl px-0">
            ...
            {/*<div className="w-full">
                ...
                <Select name="sort" value={filters.sort || ''} onChange={handleSortChange} className="w-full">
