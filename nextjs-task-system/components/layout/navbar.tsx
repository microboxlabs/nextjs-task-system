    ...
    <>
      ...
      >
       ...
       <svg
                ...
                <span className="ms-3 flex-1 whitespace-nowrap">Tasks</span>
              </a>
            </li>
            ...
            <li>
              <form action={logoutAction}>
                <button className="group flex w-full items-center rounded-lg p-2 text-left text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                  <svg
                    className="size-5 shrink-0 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
